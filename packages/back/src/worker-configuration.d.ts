/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings ./src/worker-configuration.d.ts` (hash: b0c1763d699a213e8ff952249540d872)
// Runtime types generated with workerd@1.20260410.1 2026-04-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		AIRGLOW_STOREITEM_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AIRGLOW_STOREITEM_SECRET">> {}
}
