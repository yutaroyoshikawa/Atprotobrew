...
import { useFetchStoreItems, usePutStoreItemMutation } from "@atprotobrew/common/channel/modules/storeItemsHooks";
			...
			<div className="relative z-10 flex flex-col min-h-screen">
				...
				<main className="flex-1 px-4 py-4 max-w-2xl w-full mx-auto">
					<div className="space-y-3">
						{storeItemsQuery.data.body.view.map((channel) => {
							console.log(channel);
				...
				<footer className="px-6 py-4 flex justify-center shrink-0">
					<AppButton type="button" render={(props) => <Link {...props} to="/" />}>
						Back to Launcher
					</AppButton>
				</footer>
			</div>
