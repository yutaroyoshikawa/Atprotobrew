...
import { useFetchStoreItems } from "@atprotobrew/common/channel/modules/storeItemsHooks";
import { usePutStoreItemMutation } from "@atprotobrew/common/channel/modules/storeItemsHooks";
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 px-4 py-4 max-w-2xl w-full mx-auto">
          <div className="space-y-3">
            {storeItemsQuery.data.body.record.items.map((channel) => {
              console.log(channel);

              const content = channel.storeItemRef;
