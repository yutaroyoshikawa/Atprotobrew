...
import { QrCodeDotMatrix } from "@atprotobrew/common/user/components/QrCodeDotMatrix.web";
...
export const ProfileQrCodeDialog = forwardRef<
  ProfileQrCodeDialogMethods,
    ...
    >
      ...
      <div className="flex flex-col items-center gap-4 px-5 py-6">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-textContrastMedium truncate max-w-60">
            @{handle}
          </p>
        </div>
