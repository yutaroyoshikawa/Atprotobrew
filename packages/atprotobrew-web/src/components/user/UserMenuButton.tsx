			...
			{isOpen && (
				...
				>
					<Link
						...
						role="menuitem"
						onClick={close}
						className="flex items-center gap-3 w-full px-4 py-3 text-left text-text hover:bg-bgContrast50 transition-colors"
					>
						<User size={18} className="text-textContrastMedium shrink-0" />
						<span className="text-base">プロフィール</span>
					</Link>

					<div className="mx-3 border-t border-bgContrast50" />
